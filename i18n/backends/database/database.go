 ...
 * @Jira:
 * @Wiki:
 * @Date: 2020-03-01 10:23:08
 * @LastEditors: xiaoxu@mgtv.com
 * @LastEditTime: 2020-03-01 17:12:44
 * @Description:
 * @FilePath: \qor\i18n\backends\database\database.go
 */
package database
